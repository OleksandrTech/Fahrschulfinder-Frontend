        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="max-w-5xl w-full bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row min-h-[600px]">
                ...
                <div className="hidden md:flex w-1/2 bg-gray-900 relative flex-col justify-end p-12 text-white">
                    {/* Hintergrundbild - Platzhalter, du kannst die URL ändern */}
                    <div 
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex gap-4">
                            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg flex-1 border border-white/10">
                                <div className="text-2xl font-bold">500+</div>
                                <div className="text-xs text-gray-400">Driving Schools</div>
                            </div>
                            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg flex-1 border border-white/10">
                                <div className="text-2xl font-bold">50k+</div>
                                <div className="text-xs text-gray-400">Students Reached</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors placeholder:text-gray-400 text-gray-900"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-1.5">
                                ...
                                <Link href="#" className="text-sm text-rose-600 hover:text-rose-700 hover:underline">
                                    Forgot password?
                                </Link>
                            </div>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-rose-500 transition-colors placeholder:text-gray-400 text-gray-900"
                                    required
                                />
                                <button
                                    type="button"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-rose-600 hover:bg-rose-700 text-white font-bold py-2.5 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                        ...
                        <div className="relative py-2">
                            ...
                            <div className="relative flex justify-center">
                                <span className="px-2 bg-white text-xs text-gray-500 uppercase tracking-wider">Oder fortfahren mit</span>
                            </div>
                        </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-sm text-gray-600">
                            Noch kein Konto?{' '}
                            <Link href="/registration" className="font-semibold text-rose-600 hover:text-rose-700 hover:underline">
                                Hier registrieren
                            </Link>
                        </p>
                    </div>
